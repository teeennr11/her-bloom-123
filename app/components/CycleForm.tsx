...
export default function CycleForm({ phase, edit, onSave, onCancel }: Props) {
  ...
  function save() { if (!validate()) return; onSave(form, edit?.id); setForm(EF); setErrs({}); }
  ...
  // ===== MOBILE: full-width inputs with comfortable tap height (min 44px) =====
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            onChange={e => { setForm({ ...form, startDate: e.target.value }); setErrs({ ...errs, startDate: undefined }); }}
          />
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            type="date" min={form.startDate || undefined} max={today} value={form.endDate || ''}
        ...
        <div className="flex flex-col gap-2">
          ...
          {/* ===== MOBILE: 3-column flow selector fits nicely on small screens ===== */}
            ...
            {FLOWS.map(f => {
              ...
              return (
                <button
                  ...
                  onClick={() => setForm(fm => ({ ...fm, flow: fm.flow === f.id ? "" : f.id }))}
                  // MOBILE: min 44px height for tap target
                ...
                >
                  <div className="flex gap-px">
                    {[0, 1, 2].map(i => <span key={i} className="text-[13px]" style={{ opacity: i < f.drops ? 1 : 0.2 }}>💧</span>)}
                  </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          {/* ===== MOBILE: wrapping pills; DESKTOP: same behavior ===== */}
            ...
            {SYMPTOMS.map(s => {
              ...
              return (
                <button
                  ...
                  // MOBILE: slightly taller pills for easy tapping
        ...
        <div className="flex gap-2.5 mt-0.5">
          <button
            ...
            // MOBILE: min 48px height for primary CTA
          ...
          {edit && (
            <button
              ...
              // MOBILE: min 48px height for tap target
